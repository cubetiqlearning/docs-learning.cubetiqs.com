...
### បង្កើតកម្មវិធីគេហទំព័រក្នុងលក្ខណះសាមញ្ញមួយ

អ្នកអាចបង្កើតនូវ `web controller` មួយសម្រាប់បង្កើតជាកម្មវិធីគេហទំព័រក្នុងលក្ខណះសាមញ្ញមួយ ដែលស្ថិតនៅក្នុង `folder` បែបនេះ `src/main/kotlin/com/cubetiq/springboot/HelloController.kt`:
