...
- **Flexbox** នៅក្នុង **CSS** គឺអាចធ្វើការបែងចែក `Container` នៅក្នុង គេហទំព័ររបស់អ្នកឲ្យមានលក្ខណៈស្តង់ដា រួមបញ្ចូលជាមួយនឹង `Properties` ជាច្រើន ដែលផ្តល់ភាពងាយស្រួលដល់អ្នកនៅពេលដែលអ្នកត្រូវការ ហើយវាក៏ផ្នែកមួយដ៏សំខាន់ក្នុងការធ្វើ `Responsive` ទៅលើគេហទំព័រ។
...
- ដោយយើងបានឃើញហើយថា នៅក្នុង class `content__one` គឺមិនទាន់មានកំណត់ `style` អ្វីចូលទៅក្នុងនឹងនោះទេ ដូច្នេះលទ្ធផលបង្ហាញចេញមកគឺ `boxes` ទាំងអស់នៅក្នុង `content` គឺមានលក្ខណៈធ្លាក់ចុះជាទម្រង់ជួរឈរ។
